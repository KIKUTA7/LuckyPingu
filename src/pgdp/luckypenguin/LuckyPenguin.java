...
public class LuckyPenguin {
    public static void main(String[] args) {
        ...
        while (t == false) {
            ...
            int sum = 0;
            writeBoard(fish[0],fish[1], fish[2], fish[3], fish[4], fish[5], fish[6], fish[7], fish[8]);
            ...
            if (pingu[k] == 1) System.out.println("You now have " + pingu[k] + " fish!");
            else System.out.println("You now have " + pingu[k] + " fishes!");
            if (pingu[k] == 0) {
        ...
        if (WinningNum == 1) System.out.println("The winning penguins with " + WinningNum + " fish:");
            ...
            System.out.println("The winning penguins with " + WinningNum + " fishes:");
        }
        for (int i = 0; i < num; i++) {
            if (pingu[i] == WinningNum) {
